package com.javatechie.springboot.clouddata.flow.kafka.discoverservice;
...
public class SpringBootCloudDataFlowKafkaDiscoverServiceApplication {

	Logger logger=LoggerFactory.getLogger(SpringBootCloudDataFlowKafkaDiscoverServiceApplication.class);
	
	public static void main(String[] args) {
		SpringApplication.run(SpringBootCloudDataFlowKafkaDiscoverServiceApplication.class, args);
	}
